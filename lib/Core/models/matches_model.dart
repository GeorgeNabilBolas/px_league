class MatchModel {
  ...
  MatchModel.fromJson(Map<String, dynamic> json) {
    fixture = json['fixture'] != null ? new Fixture.fromJson(json['fixture']) : null;
...
class League {
  ...
  League({this.id, this.name, this.country, this.logo, this.flag, this.season, this.round});
...
class Score {
  ...
  Score.fromJson(Map<String, dynamic> json) {
    halftime = json['halftime'] != null ? new Goals.fromJson(json['halftime']) : null;
    ...
    penalty = json['penalty'] != null ? new Fulltime.fromJson(json['penalty']) : null;
  }
